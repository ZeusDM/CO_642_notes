...
With \nameref{thm:kneser-conjecture}, we can prove Proposition~\ref{prop:hw2-ex2},
...
\begin{proposition}[Homework 2, Exercise 2] \label{prop:hw2-ex2}
    Let \(k \geq 1\) be an integer.
...
\begin{proof}
    ...
    Lastly, \nameref{thm:kneser-conjecture} implies that
    \begin{equation}
...
Theorem~\ref{thm:antipodal-open-or-closed} can be proved using \nameref{thm:borsuk-ulam}.
...
\begin{proposition}[Homework 2, Exercise 1] \label{prop:hw2-ex1}
...
\begin{proposition}[Homework 2, Exercise 4] \label{prop:hw2-ex4}
...
\begin{proposition}[Homework 2, Exercise 5]
